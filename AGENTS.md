...
root `AGENTS.md`. Edit it here, never inside a generated block (the next sync PR overwrites that
block). Keep it project-agnostic — anything specific to one repo's boundary or stack belongs
